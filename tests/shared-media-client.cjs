...
const ctx=vm.createContext({document:{querySelector:get,hidden:false},setInterval(){},ITEM_CONDITIONS:['New','Like New','Used'],CATEGORIES:['Other'],TextEncoder,AbortSignal,
